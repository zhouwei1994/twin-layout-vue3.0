<template>
  <el-dialog :title="title" custom-class="dialog_addModify" append-to-body v-model="dialogFormVisible" @close="close">
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      <el-form-item label="父分类" prop="parentId">
        <el-cascader v-model="form.parentId" :props="props" clearable></el-cascader>
      </el-form-item>
