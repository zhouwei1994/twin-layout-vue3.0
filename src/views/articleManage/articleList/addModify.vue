  ...
  <div v-loading="loading" class="qiniu-files-list-container">
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      <el-form-item label="文章类型" prop="type">
        <el-radio v-model="form.type" :label="1000" size="small" border>博客</el-radio>
        <el-radio v-model="form.type" :label="2000" size="small" border>问答</el-radio>
      </el-form-item>
      <el-form-item label="文章分类" prop="classifyId">
        <el-cascader v-model="form.classifyId" :props="props" clearable></el-cascader>
      </el-form-item>
      <el-form-item label="文章名称" prop="title">
        <el-input v-model.trim="form.title" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="文章内容" prop="content">
        <el-input v-model.trim="form.content" type="textarea" :rows="4"></el-input>
      </el-form-item>
      <el-form-item label="是否原创" prop="original">
        <el-switch v-model="form.original" active-color="#13ce66" inactive-color="#ff4949">
        </el-switch>
      </el-form-item>
