...
export default function ClassicTopBar(options) {
    ...
    let leftHtml = `<div class="twin_classic_top_bar_left">`;
    leftHtml += `</div>`;
    let $leftInfo = $(leftHtml);
    let $switchLayout = $(`<div class="twin_classic_top_bar_operating">
      <a class="twin_classic_top_bar_operating_btn" title="切换布局">
    ...
    options.$rightInfo = $(`<div class="twin_classic_top_bar_right"></div>`);
    let $notice = $(`<div class="twin_classic_top_bar_operating">
      <a class="twin_classic_top_bar_operating_btn" title="通知消息">
        <i class="twin_classic_icon_notice"></i>
        <span class="twin_classic_top_bar_operating_dot">+99</span>
      </a>
    </div>`);
    options.$rightInfo
        .append($notice);
    ...
    if (!options.mobile) {
        let $browserScreen = $(`<div class="twin_classic_top_bar_operating">
      <a class="twin_classic_top_bar_operating_btn" title="全屏">
        <i class="twin_classic_icon_browser_screen"></i>
      </a>
    </div>`);
        let $language = $(`<div class="twin_classic_top_bar_operating">
      <a class="twin_classic_top_bar_operating_btn" title="语言选择">
...
function ClassicUserInfo(options, data) {
    let html = `<div class="twin_classic_top_bar_operating">
  <a class="twin_classic_top_bar_user_info twin_classic_top_bar_operating_btn" href="javascript:void(0)">
    <img class="twin_classic_top_bar_avatar" src="${data.avatar}"/>
    <span class="twin_classic_top_bar_nickname">${data.nickname}</span>
  <i class="twin_classic_icon_arrow"></i></a></div>`;
    let $userInfoElem = $(html);
    options.$userInfoElemMenu = $(
        `<div class="twin_classic_top_bar_operating_menu"></div>`
    );
